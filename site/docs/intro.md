...
* 2.0.0-alpha10 Standalone: [production](https://npmcdn.com/catalog@2.0.0-alpha10/catalog.min.js), [development](https://npmcdn.com/catalog@2.0.0-alpha10/catalog.js)
