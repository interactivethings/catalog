...
#### Catalog 2.0.0-alpha19 (production)

Compressed, production-ready version of Catalog: https://npmcdn.com/catalog@2.0.0-alpha19/catalog.min.js

#### Catalog 2.0.0-alpha19 (development)

Uncompressed, development version of Catalog with debug information enabled: https://npmcdn.com/catalog@2.0.0-alpha19/catalog.js
