...
* Catalog 1.1.10: [production](http://interactivethings.github.io/catalog/1.1.10/catalog.min.js), [development](http://interactivethings.github.io/catalog/1.1.10/catalog.js)
...
```code
npm install --save interactivethings/catalog.git#1.1.10
```

#### Install with Bower

```code
bower install --save https://github.com/interactivethings/catalog.git#1.1.10
```
