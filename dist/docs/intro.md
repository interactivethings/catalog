...
* Catalog 1.0.1: [production](http://interactivethings.github.io/catalog/1.0.1/catalog.min.js), [development](http://interactivethings.github.io/catalog/1.0.1/catalog.js)
...
```code
npm install --save interactivethings/catalog.git#1.0.1
```

#### Install with Bower

```code
bower install --save https://github.com/interactivethings/catalog.git#1.0.1
```
