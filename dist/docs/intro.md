...
* Catalog 1.2.0: [production](http://interactivethings.github.io/catalog/1.2.0/catalog.min.js), [development](http://interactivethings.github.io/catalog/1.2.0/catalog.js)
...
```code
npm install --save interactivethings/catalog.git#1.2.0
```

#### Install with Bower

```code
bower install --save https://github.com/interactivethings/catalog.git#1.2.0
```
