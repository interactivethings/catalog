...
* Catalog 1.1.3: [production](http://interactivethings.github.io/catalog/1.1.3/catalog.min.js), [development](http://interactivethings.github.io/catalog/1.1.3/catalog.js)
...
```code
npm install --save interactivethings/catalog.git#1.1.3
```

#### Install with Bower

```code
bower install --save https://github.com/interactivethings/catalog.git#1.1.3
```
